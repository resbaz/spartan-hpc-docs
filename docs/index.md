...
* Spartan is not busy on the GPGPU partition with 60% node allocation.
* Many cloud nodes out (126), mainly due to qh2-uom migration and Ceph mount issue.
